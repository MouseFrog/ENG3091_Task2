...
int main() {
    ...
    // Generate distributed values for variables
    ...
    std::vector<std::vector<double>> raw_data(data_points, std::vector<double>(num_variables, 0.0)); // 100x3 matrix, initialise all points with value of 0.0
    ...
    const double W_bedroom = 50000;    // pounds per bedroom added
